...
export const Icon = {
  ...
  /* Stroked as well as filled, so `fill-transparent` leaves an outline rather
     than nothing at all — an unpicked star in the feedback form was invisible. */
